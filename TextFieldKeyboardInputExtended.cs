...
{
    public class TextFieldKeyboardInputExtended : TextFieldInputProviderExtended
    {
        ...
        private bool ProcessKeyPress(Event evt)
        {
            ...
            //Coffee: Make sure we aren't already at max charactes before checking the validation
